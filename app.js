...
app.post('/pdf', upload.single('file'), async (req, res) => {
  try {
    ...
    const guid = uuidv1()
    await QRCode.toFile('qr.png', 'https://crownestateapi.azurewebsites.net/QRVerify/' + guid)
    ...
    pageModifier
      .attachURLLinktoCurrentPage('https://crownestateapi.azurewebsites.net/QRVerify/' + guid, pageWidth - 100, pageHeight, pageWidth, pageHeight - 100)
